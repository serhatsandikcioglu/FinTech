        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Amount = table.Column<decimal>(type: "numeric", nullable: false),
                    MaturityTerm = table.Column<int>(type: "integer", nullable: false),
                    CreditScoreResultComment = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AutomaticPayments_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepaymentPlans_LoanApplications_LoanApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutomaticPayments_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepaymentPlans_LoanApplicationId",
